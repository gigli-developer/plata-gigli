...
export default function MoreSheet({ items, pathname, onClose }: {
  ...
  return (
    <div className="fixed inset-0 z-30 lg:hidden" role="dialog" aria-modal="true" aria-label="Más secciones">
      ...
      <div className="absolute inset-x-0 bottom-0 max-h-[70dvh] overflow-y-auto rounded-t-3xl border-t border-line bg-surface pb-[env(safe-area-inset-bottom)]">
        <div className="flex items-center justify-between px-5 pb-1 pt-4">
          <div className="mx-auto h-1 w-10 rounded-full bg-surface-3" aria-hidden />
        </div>
